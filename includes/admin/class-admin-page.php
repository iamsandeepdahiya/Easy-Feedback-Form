...
class EFF_Admin_Page {
    ...
    public static function handle_actions() {
        if (isset($_GET['action']) && $_GET['action'] === 'delete_feedback' && isset($_GET['feedback_id']) && isset($_GET['_wpnonce'])) {
            ...
            $result = EFF_Database::delete_feedback($feedback_id);
    ...
    public static function enqueue_styles($hook) {
        ...
        wp_enqueue_style(
            'eff-admin-styles',
            EFF_PLUGIN_URL . 'assets/css/admin.css',
            array(),
            EFF_VERSION
        );
    }
    ...
    private static function render_single_view() {
        require_once EFF_PLUGIN_DIR . 'includes/admin/views/single-submission.php';
    }
    ...
    private static function render_list_view() {
        require_once EFF_PLUGIN_DIR . 'includes/admin/views/list-submissions.php';
    }
} 